...
namespace Vehicles.API.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(DataContext context, IUserHelper userHelper,
            ICombosHelper combosHelper, IConverterHelper converterHelper, IBlobHelper blobHelper)
        {
            _context = context;
        ...
        public async Task<IActionResult> Edit(UserViewModel model)
        {
            if (ModelState.IsValid)
            {
                // Validate if the not user change the photo.
        ...
        public async Task<IActionResult> DeleteImageVehicle(int? id) 
        {
            ...
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index), new { id = vehiclePhoto.Vehicle.Id });
        }
